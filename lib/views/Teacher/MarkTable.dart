    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (snapshot.hasData) {
            if(widget.mCode == "CTE305" || widget.mCode == "CTE307"){
              data["columns"][4]["display"] = false;
              //data.remove(data["column"][]);
              data["columns"][0]["width_factor"] = 0.4;
              //data["columns"][2]["width_factor"] = 0.3;
            }
