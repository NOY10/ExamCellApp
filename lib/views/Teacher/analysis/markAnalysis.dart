...
class gradedMarkView extends StatefulWidget {
  final String tid;
  final String code;

  const gradedMarkView({
    required this.tid,
    required this.code,
    Key? key}) : super(key: key);

  @override
  State<gradedMarkView> createState() => _gradedMarkViewState();
}

class _gradedMarkViewState extends State<gradedMarkView> {
  ...
  GestureDetector semesterTable() {
    return GestureDetector(
      child: FutureBuilder<List<Employee>>(
        future: fetchEmployees(widget.tid, widget.code),
